...
class AHP(MCDA):
    ...
    def _criteria_matrices(self, criteria_comp: List[List]) -> Mapping[str, ComparisonMatrix]:
        sorted_comprehensions: Dict[List[List]] = {
        ...
        return {
            ...
            for parent_id, comparisons in sorted_comprehensions.items()
        }
    ...
    def _alternative_matrices(
        ...
        return {
            criteria_id: ComparisonMatrix(comparisons, self.ranking_method, self.n)
